 ...
 *
 * Parses users/{USER}/data/active-interviews.md, extracts inline `[process-friction]` tags
 ...
 * users/{USER}/data/active-interviews.md):
...
function loadActiveInterviews(path) {
