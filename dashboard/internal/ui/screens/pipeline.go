...
func getPipelineTabs() []pipelineTab {
	return []pipelineTab{
		{filterEvaluated, i18n.Current.TabOpen},
		{filterApplied, i18n.Current.TabApplied},
		{filterInterview, i18n.Current.TabInterview},
		{filterOffer, i18n.Current.TabOffer},
		{filterHired, i18n.Current.TabHired},
		{filterRejected, i18n.Current.TabRejected},
		{filterClosed, i18n.Current.TabClosed},
...
func getOptionalCols() []colDef {
	return []colDef{
		...
		{ColHasPDF, i18n.Current.ColPDF, "✓/—", 4, true},
		{ColLastContact, i18n.Current.ColContact, "", 10, true},
	}
}
...
func getStatusPairs() []StatusPair {
	return []StatusPair{
		...
		{i18n.Current.StatusClosed, "Closed"},
...
var statusGroupOrder = []string{"hired", "interview", "offer", "responded", "applied", "evaluated", "skip", "rejected", "closed", "discarded"}
...
func (m PipelineModel) renderColumnHeader() string {
	...
	if cw.last > 0 {
		segments = append(segments, cell(i18n.Current.ColContact, cw.last))
	}
...
func (m PipelineModel) renderHelp() string {
	...
	if lipgloss.Width(keys)+lipgloss.Width(right)+2 > m.width {
		// Keep the common actions and the active sort on one line at ordinary
		// terminal widths. Less-frequent shortcuts remain visible when there is
		// room instead of forcing the help row to wrap into dashboard content.
		keys = keyStyle.Render("↑↓/jk") + descStyle.Render(i18n.Current.HelpNav) +
			keyStyle.Render("←→/hl") + descStyle.Render(i18n.Current.HelpTabs) +
			keyStyle.Render("/") + descStyle.Render(i18n.Current.HelpSearch) +
			keyStyle.Render("s") + descStyle.Render(i18n.Current.HelpSort) +
