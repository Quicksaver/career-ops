...
import { careerOpsCoreEnv, careerOpsRoot, careerOpsSystemRoot, readMemory, findReportFile } from "@/lib/career-ops";
...
export async function POST(req: Request) {
  ...
  if (required && !fs.existsSync(path.join(careerOpsSystemRoot(), required))) {
    return new Response(
      JSON.stringify({
