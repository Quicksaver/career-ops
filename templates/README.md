...
node generate-latex.mjs output/123-company-2026-05-18.tex

# Or specify a custom output path
node generate-latex.mjs output/123-company-2026-05-18.tex output/123-company-2026-05-18.pdf
```
...
Defines the 10 canonical application states (`Evaluated`, `Applied`, `Responded`, `Interview`, `Offer`, `Hired`, `Rejected`, `Closed`, `Discarded`, `SKIP`) with aliases for common variants. All pipeline scripts validate statuses against this file.
