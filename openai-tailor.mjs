...
const PATHS = {
  ...
  cv:       userContext.userRoot ? userPath(userContext, 'cv.md') : '',
  profile:  userContext.userRoot ? userPath(userContext, 'config/profile.yml') : '',
  profileMode: userContext.userRoot ? userPath(userContext, 'modes/_profile.md') : '',
  customMode: userContext.userRoot ? userPath(userContext, 'modes/_custom.md') : '',
  template: join(ROOT, 'templates', 'cv-template.html'),
  output:   userContext.userRoot ? userPath(userContext, 'output') : '',
};
...
╚══════════════════════════════════════════════════════════════════╝
  ...
  USAGE
    node openai-tailor.mjs --user <id> --jd <path> --report <path>
    node openai-tailor.mjs --user <id> --url <base> --model <id> --jd <path> --report <path>
...
const profileMode    = readFile(PATHS.profileMode, 'modes/_profile.md', false);
const customMode     = readFile(PATHS.customMode, 'modes/_custom.md', false);
