#!/usr/bin/env node
/**
 * theme-style.mjs — dynamic CV/cover-letter theming from users/{USER}/config/profile.yml (#1837)
 *
 * Users declare a `style:` block in their profile.yml:
 *
 *   style:
 *     accent_color: "#2563eb"
 ...
 */
export function readStyleTokens(profilePath = null) {
  try {
