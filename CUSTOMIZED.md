...
- Upstream ref: `upstream/main` at `fe4561b0686b8e2829d5cf6c8d7bbdedb9bfb7cd`
- Fork ref: current `main` at `febaa4bd49c346cfa8efc9c7e74823be7bef22a1`, before this inventory refresh
- Relationship baseline after merge, before this inventory refresh: upstream-only commits `0`, fork-only commits `191`
- Diff-size baseline after merge, before this inventory refresh: `310 files changed, 23018 insertions(+), 3856 deletions(-)`
...
This inventory incorporates upstream 1.9 through 1.24 behavior and web v0.3.0 through v0.5.0 at `fe4561b0686b8e2829d5cf6c8d7bbdedb9bfb7cd` as the new baseline, with fork-specific routing restored where upstream still assumed a single root user.
