...
| `scan.mjs` | Zero-token portal scanner — hits Greenhouse/Ashby/Lever/PCSX APIs plus structured providers like the Landing.jobs Atom feed and ITJobs/SAPO directly, zero LLM cost |
