 ...
 *
 * Usage:
 *   node career-ops/generate-pdf.mjs [--user <id>] <input.html> <output.pdf> [--format=letter|a4] [--report=NNN] [--allow-reorder] [--max-pages=N] [--strict-pages]
 *
...
async function generatePDF() {
  ...
  if (!inputPath || !outputPath) {
    console.error('Usage: node generate-pdf.mjs [--user <id>] <input.html> <output.pdf> [--format=letter|a4] [--report=NNN] [--allow-reorder] [--max-pages=N] [--strict-pages]');
    console.error('');
